...
SELECT * FROM actor
WHERE last_name = "WILLIAMS" OR first_name LIKE "%GROUCHO%";

# 5a. You cannot locate the schema of the address table. Which query would you use to re-create it?
CREATE SCHEMA IF NOT EXISTS `sakila.address`;
...
SELECT inventory.film_id, title, count(inventory.film_id) as rentals
FROM inventory
